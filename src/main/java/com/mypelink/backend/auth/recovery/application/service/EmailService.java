...
public class EmailService {
    ...
    public void enviarCertificado(String emailDestinatario, String nombreEstudiante,
                                  ...
                                  String codigoCertificado, String pdfUrl) {
        try {
            CreateEmailOptions params = CreateEmailOptions.builder()
                    ...
                    .html(buildCertificadoEmail(nombreEstudiante, tituloCertificado,
                            nombreEmpresa, codigoCertificado, pdfUrl))
                    .build();
    ...
    private String buildCertificadoEmail(String nombreEstudiante, String titulo,
                                         String empresa, String codigo, String pdfUrl) {
        return """
    <div style="font-family:'Outfit',sans-serif;max-width:600px;margin:0 auto;background:#fff;border-radius:16px;overflow:hidden;border:1px solid #E5E7EB">
      ...
      <div style="padding:32px;text-align:center">
        ...
        <div style="margin: 24px 0;">
          <a href="%s" style="display: inline-block; background: #1B6FE8; color: white; padding: 12px 24px; text-decoration: none; border-radius: 8px; font-weight: 600;">Descargar certificado</a>
        </div>
        <p style="color:#9CA3AF;font-size:12px;margin:0">O ingresa a VincuMYPEs para ver todos tus certificados.</p>
      </div>
    </div>
    """.formatted(nombreEstudiante, titulo, empresa, codigo, pdfUrl);
    }
